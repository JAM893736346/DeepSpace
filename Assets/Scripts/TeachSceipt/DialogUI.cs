...
public class sharke : Command
{
    public float Time;
    public void sharkeTime()
    {
        AttackScense.Instance.CameraShake(Time, Time);
    }
}
...
public class DialogUI : MonoBehaviour
{
    ...
    [SerializeField] GameObject teachEnd;
    [SerializeField] GameObject DoalogUI;
    ...
    public void OneByOneExecuteCommand()
    {
        ...
        {
            DoalogUI.SetActive(false);
            teachEnd.SetActive(true);
        ...
        switch (command.AllType)
        {
            ...
            case CommandType.Say:
                ...
                {
                    AudioManager_Diolog.Instance.PlaySe(say.Sound); //播放音效
                }
                break;
            ...
            case CommandType.Bgm:
                ...
                AudioManager_Diolog.Instance.PlayBgm(bgm.Name); //播放背景音乐
            ...
            case CommandType.Bg:
                ...
                OneByOneExecuteCommand();                         //直接执行下一条
                break;
            case CommandType.sharke:
                //屏幕震动
                sharke Sharke = (sharke)command;
                Sharke.sharkeTime();
                OneByOneExecuteCommand();                         //直接执行下一条
                break;
        }
